...
class PatientGatlingTest extends Simulation {
    ...
    val authorization_header = "Basic " + Base64.getEncoder.encodeToString("Patientsapp:bXktc2VjcmV0LXRva2VuLXRvLWNoYW5nZS1pbi1wcm9kdWN0aW9uLWFuZC10by1rZWVwLWluLWEtc2VjdXJlLXBsYWNl".getBytes(StandardCharsets.UTF_8))
    ...
    val scn = scenario("Test the Patient entity")
        ...
        .formParam("client_id", "Patientsapp")
        ...
        .repeat(2) {
            ...
            .get("/services/patients/api/patients")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new patient")
            .post("/services/patients/api/patients")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/services/patients${new_patient_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created patient")
            .delete("/services/patients${new_patient_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
